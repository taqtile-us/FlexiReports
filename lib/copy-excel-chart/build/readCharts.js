...
tempFolder) {
    ...
    if (fs_1.default.existsSync(sourceFolder))
        fs_1.default.rmdirSync(sourceFolder, { recursive: true }); //remove old files that have been parced at the same location.
    fs_1.default.mkdirSync(sourceFolder);
    return new Promise((resolve, reject) => {
        try { //under the hood, excel files are zip folders containing xml files.
            const zip = new adm_zip_1.default(sourceFile);
