...
exports.readCharts = exports.extractZip = void 0;
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
...
function extractZip(zipFilePath, outputDir) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const res = yield zip.entries();
            for (const entry of Object.values(res)) {
                const { name, isDirectory } = entry;
                if (!isDirectory) {
                    const content = yield zip.entryData(name);
                    const outputPath = path.join(outputDirPath, name);
                    const dirName = path.dirname(outputPath);
                    yield fsPromised.mkdir(dirName, { recursive: true });
                    yield fsPromised.writeFile(outputPath, content);
                }
            }
        }
        catch (err) {
...
function findChartRels(chartList, tempFolder) {
    ...
    Object.values(chartList).forEach((list) => {
        list.forEach((chart) => {
            ...
            try {
                const chartRelsXML = fs_1.default.readFileSync(`${tempFolder}/xl/charts/_rels/${chart}.xml.rels`, { encoding: 'utf-8' });
                xml2js_1.default.parseString(chartRelsXML, (error, res) => __awaiter(this, void 0, void 0, function* () {
...
function findChartCellRefs(chartList, aliaslist, tempFolder, definedNames) {
    ...
    Object.values(chartList).forEach((chartList) => {
        chartList.forEach((chart) => {
            cellRefs[chart] = [];
            try {
                const chartXML = fs_1.default.readFileSync(`${tempFolder}/xl/charts/${chart}.xml`, { encoding: 'utf-8' });
    ...
    Object.keys(drawingObj).forEach(drawingName => {
        drawingObj[drawingName].forEach(el => {
            ...
            if (picElement) {
                ...
                const rIdPic = (_0 = (_z = (_y = (_x = (_w = (_v = picElement[0]) === null || _v === void 0 ? void 0 : _v['xdr:blipFill']) === null || _w === void 0 ? void 0 : _w[0]) === null || _x === void 0 ? void 0 : _x['a:blip']) === null || _y === void 0 ? void 0 : _y[0]) === null || _z === void 0 ? void 0 : _z['$']) === null || _0 === void 0 ? void 0 : _0['r:embed'];
                const picName = (_6 = (_5 = (_4 = (_3 = (_2 = (_1 = picElement[0]) === null || _1 === void 0 ? void 0 : _1['xdr:nvPicPr']) === null || _2 === void 0 ? void 0 : _2[0]) === null || _3 === void 0 ? void 0 : _3['xdr:cNvPr']) === null || _4 === void 0 ? void 0 : _4[0]) === null || _5 === void 0 ? void 0 : _5['$']) === null || _6 === void 0 ? void 0 : _6['name'];
...
function findDrawingXML(drawingObj, sourceFolder) {
    ...
    Object.keys(drawingObj).forEach((drawingName) => {
        ...
        const drawingXML = fs_1.default.readFileSync(`${sourceFolder}/xl/drawings/${drawingName}.xml`, { encoding: 'utf-8' });
        xml2js_1.default.parseString(drawingXML, (error, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            targetAnchors.forEach((el) => {
                ...
                if (pictureElement) {
                    const rIdPic = (_0 = (_z = (_y = (_x = (_w = (_v = pictureElement[0]) === null || _v === void 0 ? void 0 : _v['xdr:blipFill']) === null || _w === void 0 ? void 0 : _w[0]) === null || _x === void 0 ? void 0 : _x['a:blip']) === null || _y === void 0 ? void 0 : _y[0]) === null || _z === void 0 ? void 0 : _z['$']) === null || _0 === void 0 ? void 0 : _0['r:embed'];
                    const picName = (_6 = (_5 = (_4 = (_3 = (_2 = (_1 = pictureElement[0]) === null || _1 === void 0 ? void 0 : _1['xdr:nvPicPr']) === null || _2 === void 0 ? void 0 : _2[0]) === null || _3 === void 0 ? void 0 : _3['xdr:cNvPr']) === null || _4 === void 0 ? void 0 : _4[0]) === null || _5 === void 0 ? void 0 : _5['$']) === null || _6 === void 0 ? void 0 : _6['name'];
                    if (rIdPic) {
...
function parseDrawingRels(drawingList, tempFolder) {
    ...
    Object.entries(drawingList).forEach(([alias, name]) => {
        const drawingRelsXML = fs_1.default.readFileSync(`${tempFolder}/xl/drawings/_rels/${name}.xml.rels`, { encoding: 'utf-8' });
        xml2js_1.default.parseString(drawingRelsXML, (error, res) => __awaiter(this, void 0, void 0, function* () {
            drawingrIds[name] = {};
...
function findDrawingRels(sheetNames, tempFolder) {
    ...
    Object.entries(sheetNames).forEach(([alias, name]) => {
        if (fs_1.default.existsSync(`${tempFolder}/xl/worksheets/_rels/${name}.xml.rels`)) {
            const worksheetRelsXML = fs_1.default.readFileSync(`${tempFolder}/xl/worksheets/_rels/${name}.xml.rels`, { encoding: 'utf-8' });
            xml2js_1.default.parseString(worksheetRelsXML, (error, res) => __awaiter(this, void 0, void 0, function* () {
...
function readSheetNames(tempFolder) {
    ...
    const workbookXML = fs_1.default.readFileSync(`${tempFolder}xl/workbook.xml`, { encoding: 'utf-8' });
    xml2js_1.default.parseString(workbookXML, (error, res) => {
        var _a, _b;
    ...
    const workbookXML_rels = fs_1.default.readFileSync(`${tempFolder}xl/_rels/workbook.xml.rels`, { encoding: 'utf-8' });
    xml2js_1.default.parseString(workbookXML_rels, (error, res) => {
...
function readCharts(sourceFile, //location of file to read
tempFolder) {
    ...
    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
        try {
            yield extractZip(sourceFile, tempFolder);
