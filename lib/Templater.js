...
const buildTemplate = (dataToFill, path, reportPath, temporaryFolderPath) => __awaiter(void 0, void 0, void 0, function* () {
    const { workbook, workSheet } = yield (0, Reader_1.readFile)(path);
    const { master, details, simpleVariables, formulas, staticVariables } = yield (0, Parser_1.parse)(workSheet);
...
const fixPicturesSizes = (reportPath, temporaryFolderPath) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield (0, Reader_1.readFile)(reportPath);
